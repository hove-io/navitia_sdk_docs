...
title: StopPointsApi
nav_exclude: true
permalink: /expert/android/api/StopPointsApi
---
...
### Example
```kotlin
navitiaSdk.stopPointsApi.newCoverageLonLatStopPointsIdRequestBuilder()
    .withLat(BigDecimal())
    .withLon(BigDecimal())
    .withId("id_example")
    .withStartPage(56)
...
### Example
```kotlin
navitiaSdk.stopPointsApi.newCoverageLonLatUriStopPointsIdRequestBuilder()
    .withLat(BigDecimal())
    .withLon(BigDecimal())
    .withUri("uri_example")
    .withId("id_example")
...
### Example
```kotlin
navitiaSdk.stopPointsApi.newCoverageRegionStopPointsIdRequestBuilder()
    .withRegion("region_example")
    .withId("id_example")
    .withStartPage(56)
    .withCount(25)
...
### Example
```kotlin
navitiaSdk.stopPointsApi.newCoverageRegionUriStopPointsIdRequestBuilder()
    .withRegion("region_example")
    .withUri("uri_example")
    .withId("id_example")
    .withStartPage(56)
