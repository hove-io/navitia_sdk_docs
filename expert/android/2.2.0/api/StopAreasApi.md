...
title: StopAreasApi
nav_exclude: true
permalink: /expert/android/api/StopAreasApi
---
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageLonLatStopAreasRequestBuilder()
    .withLat(BigDecimal())
    .withLon(BigDecimal())
    .withStartPage(56)
    .withCount(25)
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageLonLatStopAreasIdRequestBuilder()
    .withLat(BigDecimal())
    .withLon(BigDecimal())
    .withId("id_example")
    .withStartPage(56)
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageLonLatUriStopAreasRequestBuilder()
    .withLat(BigDecimal())
    .withLon(BigDecimal())
    .withUri("uri_example")
    .withStartPage(56)
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageLonLatUriStopAreasIdRequestBuilder()
    .withLat(BigDecimal())
    .withLon(BigDecimal())
    .withUri("uri_example")
    .withId("id_example")
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageRegionStopAreasRequestBuilder()
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageRegionStopAreasIdRequestBuilder()
    .withRegion("region_example")
    .withId("id_example")
    .withStartPage(56)
    .withCount(25)
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageRegionUriStopAreasRequestBuilder()
    .withRegion("region_example")
    .withUri("uri_example")
    .withStartPage(56)
    .withCount(25)
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newCoverageRegionUriStopAreasIdRequestBuilder()
    .withRegion("region_example")
    .withUri("uri_example")
    .withId("id_example")
    .withStartPage(56)
...
### Example
```kotlin
navitiaSdk.stopAreasApi.newStopAreasRequestBuilder()
    .withExternalCode("externalCode_example")
    .withStartPage(56)
    .withCount(25)
    .withDepth(1)
