...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageLonLatRoutes(
    lon = 0.0,
    lat = 0.0,
    startPage = 123,
    count = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageLonLatRoutesId(
    lon = 0.0,
    lat = 0.0,
    id = "id_example",
    startPage = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageLonLatUriRoutes(
    lon = 0.0,
    lat = 0.0,
    uri = "uri_example",
    startPage = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageLonLatUriRoutesId(
    lon = 0.0,
    lat = 0.0,
    uri = "uri_example",
    id = "id_example",
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageRegionRoutes(
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageRegionRoutesId(
    region = "region_example",
    id = "id_example",
    startPage = 123,
    count = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageRegionUriRoutes(
    region = "region_example",
    uri = "uri_example",
    startPage = 123,
    count = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getCoverageRegionUriRoutesId(
    region = "region_example",
    uri = "uri_example",
    id = "id_example",
    startPage = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().routesApi.getRoutes(
    externalCode = "externalCode_example",
    startPage = 123,
    count = 123,
    depth = 123,
