...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().journeyPatternsApi.getCoverageRegionJourneyPatterns(
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().journeyPatternsApi.getCoverageRegionJourneyPatternsId(
    region = "region_example",
    id = "id_example",
    startPage = 123,
    count = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().journeyPatternsApi.getCoverageRegionUriJourneyPatterns(
    region = "region_example",
    uri = "uri_example",
    startPage = 123,
    count = 123,
...
<h3>Example</h3>
```kotlin
ExpertSdk.getInstance().journeyPatternsApi.getCoverageRegionUriJourneyPatternsId(
    region = "region_example",
    uri = "uri_example",
    id = "id_example",
    startPage = 123,
