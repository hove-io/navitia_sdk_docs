...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageLonLatPoiTypes(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageLonLatPoiTypesId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageLonLatUriPoiTypes(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageLonLatUriPoiTypesId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageRegionPoiTypes(
...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageRegionPoiTypesId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageRegionUriPoiTypes(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.poiTypesApi.getCoverageRegionUriPoiTypesId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
