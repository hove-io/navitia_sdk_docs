...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageLonLatJourneyPatterns(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageLonLatJourneyPatternsId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageLonLatUriJourneyPatterns(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageLonLatUriJourneyPatternsId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageRegionJourneyPatterns(
...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageRegionJourneyPatternsId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageRegionUriJourneyPatterns(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.journeyPatternsApi.getCoverageRegionUriJourneyPatternsId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
