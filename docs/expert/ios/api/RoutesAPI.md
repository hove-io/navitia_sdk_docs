...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageLonLatRoutes(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageLonLatRoutesId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageLonLatUriRoutes(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageLonLatUriRoutesId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageRegionRoutes(
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageRegionRoutesId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageRegionUriRoutes(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getCoverageRegionUriRoutesId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.routesApi.getRoutes(
    externalCode: "externalCode_example", 
    startPage: 56, 
    count: 25, 
    depth: 1, 
