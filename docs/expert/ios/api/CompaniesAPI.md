...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageLonLatCompanies(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageLonLatCompaniesId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageLonLatUriCompanies(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageLonLatUriCompaniesId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageRegionCompanies(
...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageRegionCompaniesId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageRegionUriCompanies(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.companiesApi.getCoverageRegionUriCompaniesId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
