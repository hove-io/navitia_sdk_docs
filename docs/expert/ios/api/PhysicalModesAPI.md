...
<h3>Example</h3>
```swift
Expert.shared.physicalModesApi.getCoverageRegionPhysicalModesId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.physicalModesApi.getCoverageRegionUriPhysicalModes(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.physicalModesApi.getCoverageRegionUriPhysicalModesId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
