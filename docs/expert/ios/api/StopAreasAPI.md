...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageLonLatStopAreas(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageLonLatStopAreasId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageLonLatUriStopAreas(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageLonLatUriStopAreasId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageRegionStopAreas(
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageRegionStopAreasId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageRegionUriStopAreas(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getCoverageRegionUriStopAreasId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.stopAreasApi.getStopAreas(
    externalCode: "externalCode_example", 
    startPage: 56, 
    count: 25, 
    depth: 1, 
