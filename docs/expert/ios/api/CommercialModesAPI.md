...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageLonLatCommercialModes(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageLonLatCommercialModesId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageLonLatUriCommercialModes(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageLonLatUriCommercialModesId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageRegionCommercialModes(
...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageRegionCommercialModesId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageRegionUriCommercialModes(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.commercialModesApi.getCoverageRegionUriCommercialModesId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
