...
<h3>Example</h3>
```swift
Expert.shared.disruptionsApi.getCoverageLonLatUriDisruptionsId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.disruptionsApi.getCoverageRegionDisruptions(
...
<h3>Example</h3>
```swift
Expert.shared.disruptionsApi.getCoverageRegionDisruptionsId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
