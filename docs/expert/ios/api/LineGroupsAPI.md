...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageLonLatLineGroups(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageLonLatLineGroupsId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageLonLatUriLineGroups(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageLonLatUriLineGroupsId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageRegionLineGroups(
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageRegionLineGroupsId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageRegionUriLineGroups(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getCoverageRegionUriLineGroupsId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.lineGroupsApi.getLineGroups(
    externalCode: "externalCode_example", 
    startPage: 56, 
    count: 25, 
    depth: 1, 
