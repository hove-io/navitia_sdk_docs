...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageLonLatDatasets(
    lat: 3.4, 
    lon: 3.4, 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageLonLatDatasetsId(
    lat: 3.4, 
    lon: 3.4, 
    id: "id_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageLonLatUriDatasets(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    startPage: 56, 
...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageLonLatUriDatasetsId(
    lat: 3.4, 
    lon: 3.4, 
    uri: "uri_example", 
    id: "id_example", 
...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageRegionDatasets(
...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageRegionDatasetsId(
    region: "region_example", 
    id: "id_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageRegionUriDatasets(
    region: "region_example", 
    uri: "uri_example", 
    startPage: 56, 
    count: 25, 
...
<h3>Example</h3>
```swift
Expert.shared.datasetsApi.getCoverageRegionUriDatasetsId(
    region: "region_example", 
    uri: "uri_example", 
    id: "id_example", 
    startPage: 56, 
